...
//#define ASSISTED_TRAMMING
  ...
  #define ASSISTED_TRAMMING_WIZARD    // Add a Tramming Wizard to the LCD menu   //Per Dustin
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #if HAS_BED_PROBE
    #define PROBE_OFFSET_WIZARD                    //Per Dustin
      ...
      //
      #define PROBE_OFFSET_WIZARD_START_Z 0.0  //Per Dustin
  ...
  #define LCD_SET_PROGRESS_MANUALLY                   //Per Dustin
 ...
 */
#define ADVANCED_PAUSE_FEATURE                    //Per Dustin
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      EXTRUDE_MAXLENGTH  // (mm) The length of filament for a complete unload.     /Per Dustin
  ...
  #define PARK_HEAD_ON_PAUSE                      // Park the nozzle during pause and filament change.      //Per Dustin
  //#define HOME_BEFORE_FILAMENT_CHANGE           // If needed, home before parking for filament change

  #define FILAMENT_LOAD_UNLOAD_GCODES             // Add M701/M702 Load/Unload G-codes, plus Load/Unload in the LCD Prepare menu.     //Per Dustin
